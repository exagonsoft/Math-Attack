...
{
    [SerializeField] Cursor_Manager.CursorType cursorType;
    ...
    {
        Cursor_Manager.Instance.SetActiveCursor(cursorType);
        SoundManager.PlaySound(SoundManager.GameSounds.UIOver);
    ...
    {
        Cursor_Manager.Instance.SetActiveCursor(Cursor_Manager.CursorType.Arrow);
        SoundManager.PlaySound(SoundManager.GameSounds.UIClick);
